...
// Jumlah encoder = 2 (Sofle kiri & kanan)
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {

    // ===== Layer 0: QWERTY =====
    [_QWERTY] = {
        ENCODER_CCW_CW(KC_VOLD, KC_VOLU),   // Encoder kiri
        ENCODER_CCW_CW(KC_PGUP, KC_PGDN)    // Encoder kanan
    },
    ...
    // ===== Layer 4: ADJUST =====
    [_ADJUST] = {
        ENCODER_CCW_CW(QK_BOOT, QK_BOOT),
